  ...
  return (
    <>
      <div className="container mt-24">
        <div className="container border border-b-500 rounded-md shadow-md">
          <div className="flex flex-wrap items-center">
            <div className="hidden w-full xl:block xl:w-1/2">
              <div className="grid grid-cols-3">
                ...
                <span className="col-span-2 mr-2">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit
                  suspendisse.
                </span>
              </div>

              <div className="py-17.5 px-26 pt-[7%] text-center">
            ...
            <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
              <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                ...
                <form>
                  <div className="mb-4">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full rounded-md border border-stroke bg-transparent p-2 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                      />

                      <span className="absolute right-4 mt-2">
                        <svg
                  ...
                  <button className="flex w-full items-center justify-center gap-3.5 rounded-md border border-stroke bg-gray p-2 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50">
                    <span>
                      <svg
                        width="20"
                        height="20"
