                    ...
                    <div className="bg-white shadow-2xl rounded-md flex flex-col items-stretch relative">
                      <div className="relative px-8 py-8 pb-11">
                        ...
                        <div className="absolute bottom-4 left-7">
                          <button
                            className="relative cursor-pointer rounded-md mb-2 text-left focus:outline-none focus-visible:border-gray-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-300 sm:text-sm text-gray-700 text-base flex items-center"
