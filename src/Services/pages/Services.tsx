...
export default function Services() {
  ...
  return (
    <>
      <div className="container p-[2%] relative m-auto">
        <label
          htmlFor="message"
        ...
        <textarea
          id="message"
          className="w-full pb-[35%] p-[5%] text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
