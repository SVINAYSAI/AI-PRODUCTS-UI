...
import p from "../../../../../components/assets/imgs/half2.jpg";
      ...
      <div>
        <div className="mt-4">
          ...
          <div className="grid grid-cols-12 mt-3">
            ...
            <span className="text-sm col-span-11">
              Chart Generation upto 120 Times.
            </span>
          </div>
          ...
          <div className="mt-3 grid grid-cols-12">
            ...
            <span className="text-sm col-span-11">
              20 Min Audio to Transcript upto 40 Times.
            </span>
          </div>
          ...
          <div className="mt-3 grid grid-cols-12">
            ...
            <span className="text-sm col-span-11">
              20 Min Video to Transcript upto 30 Times.
            </span>
          </div>
          ...
          <div className="mt-3 grid grid-cols-12">
            ...
            <span className="text-sm col-span-11">
              8 Min Video to Transcript on Video upto 20 Times.
            </span>
          </div>
          ...
          <div className="mt-3 grid grid-cols-12">
            ...
            <span className="text-sm col-span-11">
              Text to Voice Generation with 1500 characters & 18 different
              voices upto 20 Times.
            </span>
          </div>
          ...
          <div className="mt-3 grid grid-cols-12">
            ...
            <span className="text-sm col-span-11">
              5 Min Text to Video Generation upto 15 Times.
            </span>
          </div>
          ...
          <div className="mt-3 grid grid-cols-12">
            ...
            <span className="text-sm col-span-11">
              Generate different AI Avatars 30sec Video upto 8 Times .
            </span>
          </div>
        </div>
      </div>
