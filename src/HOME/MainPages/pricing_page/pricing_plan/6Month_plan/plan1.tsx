...
import p from "../../../../../components/assets/imgs/half1.png";
      ...
      <div>
        <div className="mt-4">
          ...
          <div className="grid grid-cols-12 mt-3">
            ...
            <span className="text-sm col-span-11">
              Chart Generation upto 80 Times.
            </span>
          </div>
          ...
          <div className="mt-3 grid grid-cols-12">
            ...
            <span className="text-sm col-span-11">
              10 Min Audio Transcript upto 30 Times.
            </span>
          </div>
          ...
          <div className="mt-3 grid grid-cols-12">
            ...
            <span className="text-sm col-span-11">
              Text to Voice Generation with 700 characters & 6 different voices
              upto 30 Times.
            </span>
          </div>
          ...
          <div className="mt-3 grid grid-cols-12">
            ...
            <span className="text-sm col-span-11">
              10 Min Video to Transcript upto 10 Times.
            </span>
          </div>
        </div>
      </div>
