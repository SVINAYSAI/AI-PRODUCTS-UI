...
import p from "../../../../../components/assets/imgs/p.jpg";
      ...
      <div>
        <div className="mt-4">
          ...
          <div className="grid grid-cols-12 mt-3">
            ...
            <span className="text-sm col-span-11">
              Chart Generation upto 100 Times.
            </span>
          </div>
          ...
          <div className="mt-3 grid grid-cols-12">
            ...
            <span className="text-sm col-span-11">
              20 Min Audio to Transcript upto 35 Times.
            </span>
          </div>
          ...
          <div className="mt-3 grid grid-cols-12">
            ...
            <span className="text-sm col-span-11">
              20 Min Video to Transcript upto 18 Times.
            </span>
          </div>
          ...
          <div className="mt-3 grid grid-cols-12">
            ...
            <span className="text-sm col-span-11">
              10 Min Video to Transcript on Video upto 10 Times.
            </span>
          </div>
          ...
          <div className="mt-3 grid grid-cols-12">
            ...
            <span className="text-sm col-span-11">
              Text to Voice Generation with 1800 characters & 12 different
              voices upto 35 Times.
            </span>
          </div>
          ...
          <div className="mt-3 grid grid-cols-12">
            ...
            <span className="text-sm col-span-11">
              4 Min Text to Video Generation upto 10 Times.
            </span>
          </div>
