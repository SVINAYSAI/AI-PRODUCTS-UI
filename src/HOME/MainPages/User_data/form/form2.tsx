...
export default function Form2(){
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const response = await fetch("http://localhost:5000/company_login/check_credentials", {
      method: "POST",
      headers: {
    ...
    if (data.credentials_match) {
      // Set a cookie indicating the button is clicked
      cookies.set("buttonClicked", true, { path: "/companyloginCookies" });
