...
import Img from "../../components/assets/imgs/avatar-1.jpg";
            ...
            <div className="col-lg-12 col-md-12 col-12">
              <div className="p-6 d-lg-flex justify-content-between align-items-center ">
                <div className="d-md-flex align-items-center">
                  <img src={Img} alt="Image" className="rounded-circle w-16" />
                ...
                <button className="border mt-2 p-1 bg-white rounded-md">
                  <Link to="#!" className="">
